...
INSERT INTO "new_Project" ("code", "companyId", "createdAt", "description", "documentUploadLink", "dueDate", "holdReason", "id", "name", "progress", "projectManagerId", "startDate", "status", "updatedAt") SELECT "code", "companyId", "createdAt", "description", "documentUploadLink", "dueDate", "holdReason", "id", "name", "progress", "projectManagerId", "startDate", "status", "updatedAt" FROM "Project";
DROP TABLE "Project";
